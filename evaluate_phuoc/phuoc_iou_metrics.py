...
class DetectionIoUEvaluator(object):
    ...
    def compute_results(self):
        self.results = []
        for gt, pred in zip(self.all_gts, self.all_preds):
            self.results.append(self.evaluate_image(gt, pred))
           
        self.metrics =  self.combine_results(self.results)
        print(self.metrics)
        self.all_gts  = []
        self.all_preds = []
